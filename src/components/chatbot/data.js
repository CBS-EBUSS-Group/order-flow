const text = {
  firstHomeVisit: [
    ...
    "To get you going, we’ve given you 10,000€ worth of buying power. I will guide you along the steps and if I'm in the way you can click on the speechbubble and I will disappear.",
    "Are you ready for your first investment? Go ahead and click on Buy!",
  ],
  firstMarketPageVisit: [
    "This is our market page. Here you can find the currently trending stocks and fonds. Whenever you are ready, select a security by clicking on it. 🙂",
  ],
  firstBuyPageVisit: [

const text = {
  ...
  firstMarketPageVisit: [
    "This is our market page. Here you can find the currently most popular/ trending stocks and fonds. Whenever you are ready, select a security by clicking on it. 🙂",
  ],
  firstBuyPageVisit: [
